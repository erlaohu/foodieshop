...
//                     // 查询商品sku结束
                ...
                // 根据订单类型判断订单相关操作
                if ($order_list['data'][$k]['order_type'] == 1 || $order_list['data'][$k]['order_type'] == 3 || $order_list['data'][$k]['order_type'] == 5 || $order_list['data'][$k]['order_type'] == 7) {
    ...
    public static function getOrderStatusNum($condition = '')
    {
        ...
        $condition['is_evaluate'] = 0; // 未评价
        $orderStatusNum['wait_evaluate_appointment'] = $order->where($condition)->count(); // 待评价
     ...
     * @param unknown $order_id
     */
    public function setOrderAppointmentComplete($order_id){
        ...
        try {
            ...
            $result = $order_model->save(['order_status'=>8], $order_condition);
