    ...
    public function getGoodsCategoryBlockQuery($shop_id, $show_num = 4)
    {
        ...
        if (empty($cache)) {
            ...
            foreach ($goods_category_block_list as $k => $v) {
                ...
                $goods_list = $goods->getGoodsQueryLimit($condition, "ng.goods_id,ng.goods_type,ng_sap.pic_cover_small,ng.goods_name,ng.promotion_price,ng.state,ng.shipping_fee,ng.group_id_array,ng.point_exchange_type,ng.point_exchange", $show_num, $order);
