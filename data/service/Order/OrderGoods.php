        ...
        try {
            ...
            foreach ($goods_sku_list_array as $k => $goods_sku_array) {
                ...
                if (! empty($appointment_date)) {
                    ...
                    $goods_sku_info['stock'] = $goods_stock_info['stock'];
                }
                ...
                $sku_price = $goods_promote->getGoodsSkuPrice($goods_sku_info['sku_id'], $appointment_date);
                // 获取商品阶梯优惠后的价格
                ...
                $goods_calculate->subGoodsStock($goods_sku_info['goods_id'], $goods_sku_info['sku_id'], $goods_sku[1], '', $appointment_date);
