...
class Order extends BaseService
{
    ...
    public function orderCreateBragain($out_trade_no, $goods_sku_list, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $bragain_money, $uid){
        ...
        try {
            ...
            $pay_money = $order_money - $bragain_money;
            $deliver_price = 0;
            $pay_status = 0;
            ...
            foreach ($order_goods_list as $k => $v) {
                ...
                if ($return_stock == 1) {
                    ...
                    if (! empty($v['appointment_date'])) {
                        ...
                        $data_goods_stock = $goods_stock_model->getInfo([
                            'goods_id' => $goods_sku_info['goods_id'],
                            'sku_id' => $v['sku_id'],
                            'appointment_date' => $v['appointment_date']
                        ], 'stock');
                        $goods_stock_model->save([
                            'stock' => $data_goods_stock['stock'] + $v['num']
                        ], [
                            'goods_id' => $goods_sku_info['goods_id'],
                            'sku_id' => $v['sku_id'],
                            'appointment_date' => $v['appointment_date']
    ...
    public function getDetail($order_id)
    {
        ...
        } else if ($order_detail['order_type'] == 6) {
