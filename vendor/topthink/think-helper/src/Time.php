...
class Time
{
     ...
     * @return int
     */
    public static function dateAfter($day = 1, $dateFormat = "Y-m-d")
    {
        $nowTime = time();
        return date($dateFormat, $nowTime + self::daysToSecond($day));
    }
     ...
     * @return array
     */
    public static function todayDate($dateFormat = "Y-m-d")
    {
        return date($dateFormat, mktime(0, 0, 0, date('m'), date('d'), date('Y')));
    }
